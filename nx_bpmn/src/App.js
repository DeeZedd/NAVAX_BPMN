...
import nx_BpmnLoader from './components/nx_BpmnLoader.tsx';
...
function App() {
  ...
  return (
    <>
      ...
      {/* <div className="App">
        <header className="App-header" id='canvas'>
        </header>
      </div> */}
    </>
  )
