...
function drawStatus(parentGfx, width, height, r, offset) {
    ...
    var points = [
        { x: 0, y: 0 }, { x: sub, y: 0 }, { x: lastSub, y: 0 }, { x: width, y: 0 },
        { x: width, y: height }, { x: lastSub, y: height }, { x: sub, y: height }, { x: 0, y: height },
        { x: 0, y: 0 }, { x: sub, y: 0 }, { x: sub, y: height }, { x: lastSub, y: height }, { x: lastSub, y: 0 }
    ];
